...
var CalendarRangeSelector = function (_a) {
    var handleResetSelectedDays = _a.handleResetSelectedDays, startDate = _a.startDate, endDate = _a.endDate, setStartDate = _a.setStartDate, setEndDate = _a.setEndDate, handleShowCalendar = _a.handleShowCalendar, handleOkPress = _a.handleOkPress;
    ...
    var handleDayPress = function (day) {
        var normalizedDay = day.clone().startOf('day'); // Normalize to the start of the day
    ...
    var generateCalendar = function () {
        ...
        while (date.isBefore(endDay, 'day')) {
            calendar.push(Array(7).fill(0).map(function () { return date.add(1, 'day').clone().startOf('day'); }) // Ensure all dates are normalized
            );
        }
        return calendar;
    };
    ...
    return (react_1.default.createElement(react_native_1.View, { style: styles_1.default.container },
        react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: function () { return setDropdownVisible(true); }, style: styles_1.default.monthSelectorButton },
        ...
        react_1.default.createElement(react_native_1.Modal, { animationType: "fade", transparent: true, visible: dropdownVisible, onRequestClose: function () { return setDropdownVisible(false); } },
            react_1.default.createElement(react_native_1.View, { style: styles_1.default.modalView },
                react_1.default.createElement(react_native_1.ScrollView, { style: styles_1.default.dropdown }, isSelectingYear ? (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(react_native_1.Text, { style: styles_1.default.dropdownLabel }, "Select Year"),
                    Array.from({ length: (0, moment_1.default)().year() - 1970 + 11 }, function (_, i) { return (0, moment_1.default)().year() + 10 - i; }).map(function (year, index) { return (react_1.default.createElement(react_native_1.TouchableOpacity, { key: index, style: styles_1.default.dropdownItem, onPress: function () { return onYearSelect(year); } },
                        react_1.default.createElement(react_native_1.Text, null, year))); }))) : (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(react_native_1.Text, { style: styles_1.default.dropdownLabel }, "Select Month"),
                    getMonths().map(function (month, index) { return (react_1.default.createElement(react_native_1.TouchableOpacity, { key: index, style: styles_1.default.dropdownItem, onPress: function () { return onMonthSelect(index); } },
                        react_1.default.createElement(react_native_1.Text, null, month))); })))),
                react_1.default.createElement(react_native_1.TouchableOpacity, { style: styles_1.default.closeButton, onPress: function () { return setDropdownVisible(false); } },
        ...
        calendar.map(function (week, index) { return (react_1.default.createElement(react_native_1.View, { key: index, style: styles_1.default.week }, week.map(function (day) { return (react_1.default.createElement(react_native_1.TouchableOpacity, { key: day.format('DD MM YYYY'), style: [
                ...
                ((startDate && endDate && day.isAfter(startDate, 'day') && day.isBefore(endDate, 'day'))) ? styles_1.default.inRangeDay : {}
            ], onPress: function () { return handleDayPress(day); } },
        ...
        react_1.default.createElement(react_native_1.View, { style: styles_1.default.actionContainer },
            ...
            react_1.default.createElement(react_native_1.TouchableOpacity, { style: styles_1.default.actionButton, onPress: function () { handleShowCalendar(false); handleOkPress(); } },
